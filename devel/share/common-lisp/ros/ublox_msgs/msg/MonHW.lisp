...
;//! \htmlinclude MonHW.msg.html

(cl:defclass <MonHW> (roslisp-msg-protocol:ros-message)
  ((pinSel
    :reader pinSel
    :initarg :pinSel
    :type cl:integer
...
(cl:defclass MonHW (<MonHW>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MonHW>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MonHW)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ublox_msgs-msg:<MonHW> is deprecated: use ublox_msgs-msg:MonHW instead.")))

(cl:ensure-generic-function 'pinSel-val :lambda-list '(m))
(cl:defmethod pinSel-val ((m <MonHW>))
...
(cl:defmethod pinBank-val ((m <MonHW>))
...
(cl:defmethod pinDir-val ((m <MonHW>))
...
(cl:defmethod pinVal-val ((m <MonHW>))
...
(cl:defmethod noisePerMS-val ((m <MonHW>))
...
(cl:defmethod agcCnt-val ((m <MonHW>))
...
(cl:defmethod aStatus-val ((m <MonHW>))
...
(cl:defmethod aPower-val ((m <MonHW>))
...
(cl:defmethod flags-val ((m <MonHW>))
...
(cl:defmethod reserved0-val ((m <MonHW>))
...
(cl:defmethod usedMask-val ((m <MonHW>))
...
(cl:defmethod jamInd-val ((m <MonHW>))
...
(cl:defmethod reserved1-val ((m <MonHW>))
...
(cl:defmethod pinIrq-val ((m <MonHW>))
...
(cl:defmethod pullH-val ((m <MonHW>))
...
(cl:defmethod pullL-val ((m <MonHW>))
  ...
  (pullL m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<MonHW>)))
    "Constants for message type '<MonHW>"
  '((:CLASS_ID . 10)
    (:MESSAGE_ID . 9)
    (:A_STATUS_INIT . 0)
    (:A_STATUS_UNKNOWN . 1)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MonHW>) ostream)
  "Serializes a message object of type '<MonHW>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MonHW>) istream)
  "Deserializes a message object of type '<MonHW>"
  ...
  (cl:setf (cl:slot-value msg 'VP) (cl:make-array 17))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MonHW>))
