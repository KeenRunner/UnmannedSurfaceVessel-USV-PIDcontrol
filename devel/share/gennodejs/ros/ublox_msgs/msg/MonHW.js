...
class MonHW {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.VP.length !== 17) {
      throw new Error('Unable to serialize array field VP - length must be 17')
    }
    // Serialize message field [VP]
    bufferOffset = _arraySerializer.uint8(obj.VP, buffer, bufferOffset, 17);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.VP = _arrayDeserializer.uint8(buffer, bufferOffset, 17)
  ...
  static Resolve(msg) {
    ...
    if (msg.VP !== undefined) {
      ...
      resolved.VP = new Array(17).fill(0)
    }
